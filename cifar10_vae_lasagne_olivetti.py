...
elif dataset is 'olivetti':
    model_filename = "olivetti_model"
else:
...
if dataset is 'cifar':
    ...
    plt.imshow(adv_plot(train_x[orig_img][np.newaxis, :]).reshape(shapesize,shapesize), cmap='Greys_r')
...
if dataset is 'cifar':
    ...
    plt.imshow(train_x[orig_img].reshape(shapesize,shapesize), cmap='Greys_r')
    plt.title("Original image")
    plt.show()
    plt.imshow(train_x[target_img].reshape(shapesize,shapesize), cmap='Greys_r')
    plt.title("Target image")
    plt.show()
    plt.imshow(x.reshape(shapesize,shapesize), cmap='Greys_r')
    plt.title("Adversarial noise")
    plt.show()
    plt.imshow((train_x[orig_img]+x).reshape(shapesize,shapesize), cmap='Greys_r')
